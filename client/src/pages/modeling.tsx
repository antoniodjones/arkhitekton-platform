...
import { PanelLeftOpen, PanelLeftClose, Home, Save, Users, Search, Sparkles, Bot, AlertTriangle, ArrowLeft, Shapes, Settings } from 'lucide-react';
...
function ModelingContent() {
  ...
  return (
    <div className="h-full overflow-hidden flex flex-col">
      ...
      {aiAssistantOpen && (
        <AIAssistant
          context={selectedElement ? `Analyzing ${selectedElement.name} (${selectedElement.type}) from ${selectedElement.framework}` : 'Architecture modeling'}
